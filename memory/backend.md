...
- **Схема и миграции:**
  ...
  - `src/db/migrations/` — инкрементальные миграции (типизированная память `009_typed_memory.sql`, инициативы Леры `007_lera_content_initiatives.sql`, radiant `001_strict_radiant.sql`).
