...
CREATE TABLE IF NOT EXISTS prompt_logs (
    id BIGSERIAL PRIMARY KEY, user_id BIGINT NOT NULL, kind VARCHAR(32) NOT NULL DEFAULT 'CHAT', mode VARCHAR(32), model VARCHAR(160), provider_name VARCHAR(120), user_text TEXT, system_prompt TEXT, radiant_context TEXT, messages JSONB NOT NULL DEFAULT '[]'::jsonb, state_snapshot JSONB NOT NULL DEFAULT '{}'::jsonb, memory_used JSONB NOT NULL DEFAULT '[]'::jsonb, raw_response TEXT, parsed_response TEXT, usage JSONB NOT NULL DEFAULT '{}'::jsonb, prompt_tokens INT NOT NULL DEFAULT 0, completion_tokens INT NOT NULL DEFAULT 0, total_tokens INT NOT NULL DEFAULT 0, cost_usd NUMERIC(16,8) NOT NULL DEFAULT 0, command_gate_status VARCHAR(32), command_gate_reason TEXT, latency_ms INT NOT NULL DEFAULT 0, is_photo_request BOOLEAN NOT NULL DEFAULT FALSE, error_text TEXT, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
