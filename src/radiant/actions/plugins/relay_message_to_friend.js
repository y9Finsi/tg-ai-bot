...
export const relayMessageToFriendAction = {
    ...
    description: 'Передает сообщение, просьбу, привет или реплику общему знакомому или другу («передай Богдану, что...», «черкани Юте...», «напиши юте что...», «скажи @username...»). Вызывай ОБЯЗАТЕЛЬНО, когда пользователь просит передать или написать что-то другому человеку. Не путай собеседника с получателем! Поддерживает задержку, чтобы выглядеть живо.',
    inputSchema: {
        type: 'object',
        properties: {
            target: {
