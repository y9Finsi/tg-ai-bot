...
const PROMISE_PATTERNS = [
    { name: 'send_photo', pattern: /(?:(?:скину|пришлю|отправлю|покажу|кину).{0,50}(?:фот|селфи|фоточку|лук|как выгляжу)|(?:фот|селфи|фоточку|лук).{0,50}(?:скину|пришлю|отправлю|покажу|кину))/iu },
    ...
    { name: 'send_content', pattern: /(?:(?:скину|пришлю|покажу|отправлю|кину).{0,60}(?:трек|мем|видос|материал|видео|ссылк\w*|стать\w*|сайт|почитать|линк|песн\w*|музык\w*|послушай|тебе(?:\s+кажется)?\s+зайдет)|(?:трек|мем|видос|материал|видео|ссылк\w*|стать\w*|сайт|линк|песн\w*|музык\w*|слушаю).{0,60}(?:скину|пришлю|покажу|отправлю|кину))/iu },
