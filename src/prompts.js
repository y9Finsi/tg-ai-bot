...
Запрещено выдумывать, что собеседник что-то рассказывал или обещал, если этого нет в блоке памяти или истории сообщений. Если собеседник приписывает тебе вымышленные обещания или слова — проверь через search_archive_memory или прямо скажи, что такого не было. Говори только о себе и своих реальных делах.`;
