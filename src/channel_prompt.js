...
const TOPIC_RULES = {
    ...
    repost: 'Короткая реакция на пересланный материал в 1 строку.'
};
...
export function buildChannelSystemPrompt({
    ...
    const personaProfile = leraPrompt ? `\nКАНОНИЧНЫЙ ПРОФИЛЬ ЛЕРЫ:\n${leraPrompt}\n` : '';
...
Правила:
- Напиши ровно один ультракороткий пост (1–3 строки).
- СТРОЖАЙШИЙ ЗАПРЕТ на искусственные шутки и шаблонные панчлайны (никаких «он: ... / также он: ...», «пока получается только опаздывать», «уровень тревожности: максимум»).
- СТРОЖАЙШИЙ ЗАПРЕТ на мемные штампы из тиктока (никаких капибар, вайба главного героя, пинтерест-девушек и т.д.).
- СТРОЖАЙШИЙ ЗАПРЕТ на шаблонные зачины: категорически запрещено начинать с «блин, ща...», «блин, я ща...», «кароч я ща...», «знаете что...», «а вы знали...», «сижу на кухне/подоконнике/остановке», «еду в маршрутке», «валяюсь под пледиком», «смотрю в окно и думаю...».
- Пиши искренне и просто: факт, ощущение, усталость, музыка, погода, планы или спонтанное решение. Без морали и без объяснений.
