...
- Отклоняй (REJECT:CHANNEL_CLICHE), если пост прямо начинается с шаблонных зачинов («сижу на кухне/подоконнике», «еду в маршрутке», «знаете что...», «а вы знали...») или построен по формуле искусственного анекдота с панчлайном («он: ... / также он: ...»).
...
- Отклоняй (REJECT:CHANNEL_FORMAT), если пост содержит списки, дефисы в начале строк или много эмодзи.
