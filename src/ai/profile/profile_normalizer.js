...
export function normalizeRule(rule = {}, index = 0) {
    ...
    return {
        ...
        top_p: rule.top_p !== undefined ? Number(rule.top_p) : undefined,
        frequency_penalty: rule.frequency_penalty !== undefined ? Number(rule.frequency_penalty) : undefined,
        presence_penalty: rule.presence_penalty !== undefined ? Number(rule.presence_penalty) : undefined,
