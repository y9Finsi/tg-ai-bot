...
9. send_content: когда собеседник просит трек, мем, видос, ссылку, статью или сайт («скинь трек», «покажи мем», «скинь ссылку», «дай почитать», «че за статья») или ты сама хочешь скинуть конкретный материал из своих закладок — вызывай send_content(category, query). КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать в тексте «держи», «скинула» или выдумывать ссылки из головы без вызова send_content!`
};
