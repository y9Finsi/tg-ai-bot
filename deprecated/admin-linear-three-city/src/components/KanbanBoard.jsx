        ...
        <div className="bg-[#0e1013] border border-white/[0.06] rounded-xl p-3 sm:p-3.5 space-y-3 w-full">
            ...
            <div className="overflow-x-auto no-scrollbar pb-0.5">
                <div className="grid grid-cols-4 min-w-[620px] sm:min-w-0 gap-2 items-start">
                    {/* 1. ПРЕДСТОИТ */}
                    <div className="rounded-xl bg-black/20 border border-white/[0.04] p-2 min-h-[240px] flex flex-col">
                    ...
                    {/* 2. В ПРОЦЕССЕ */}
                    <div className="rounded-xl bg-[#5e6ad2]/[0.03] border border-[#5e6ad2]/20 p-2 min-h-[240px] flex flex-col">
                        <div className="flex items-center justify-between mb-1.5 px-1">
                    ...
                    {/* 3. СДЕЛАНО */}
                    <div className="rounded-xl bg-emerald-950/[0.04] border border-emerald-500/10 p-2 min-h-[240px] flex flex-col">
                        <div className="flex items-center justify-between mb-1.5 px-1">
                    ...
                    {/* 4. ОТМЕНЕНО */}
                    <div className="rounded-xl bg-rose-950/[0.04] border border-rose-500/10 p-2 min-h-[240px] flex flex-col">
                        <div className="flex items-center justify-between mb-1.5 px-1">
