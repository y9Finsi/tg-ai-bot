...
## 6. Memory Agent (Субагент памяти)

В проекте зарегистрирован субагент **`memory_agent`**:
- **Директивы и контекст:** [`.agents/memory_agent/`](file:///Users/bogdan/Desktop/Telegram-AI-bot-with-payments-main/.agents/memory_agent/)
- **Зона ответственности:** непрерывный аудит 7 слоев памяти в `memory/`, поддержание консистентности `AGENTS.md` с реальным кодом, фиксация архитектурных изменений и gotchas.
- **Вызов:** `invoke_subagent` с `TypeName: "memory_agent"`.
